...
class DertamSelectDate {
  static Future<Map<String, dynamic>?> show(BuildContext context) {
    return Navigator.of(context).push<Map<String, dynamic>>(
      AnimationUtils.popup(_DertamSelectDateDialog()),
    );
  }
}

class _DertamSelectDateDialog extends StatefulWidget {
  @override
  State<_DertamSelectDateDialog> createState() =>
      _DertamSelectDateDialogState();
}

class _DertamSelectDateDialogState extends State<_DertamSelectDateDialog> {
