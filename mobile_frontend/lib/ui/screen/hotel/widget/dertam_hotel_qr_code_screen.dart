...
class DertamQrCodeScreen extends StatefulWidget {
  final String? qrData;
  final String? qrImage;
  final String bookingId;

  const DertamQrCodeScreen({
    super.key,
    this.qrData,
    this.qrImage,
  ...
  @override
  State<DertamQrCodeScreen> createState() => _DertamQrCodeScreenState();
}

class _DertamQrCodeScreenState extends State<DertamQrCodeScreen> {
  Timer? _pollingTimer;
  ...
  Future<void> _checkPaymentStatus() async {
    ...
    try {
      ...
      final status = bookingDetail.data.status;
      setState(() {
      ...
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () => hotelProvider
                .cancelHotelBooking(widget.bookingId)
