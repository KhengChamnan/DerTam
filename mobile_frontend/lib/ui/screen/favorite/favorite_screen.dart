  ...
  List<Place> _getMockFavoritePlaces() {
    return [
      Place(
        placeId: '1',
        name: 'Angkor Wat',
        description: 'Ancient temple complex and UNESCO World Heritage Site. One of the most magnificent architectural wonders in the world.',
        categoryId: 1,
        googleMapsLink: 'https://maps.google.com/?q=Angkor+Wat,+Krong+Siem+Reap,+Cambodia',
        ratings: 4.8,
        reviewsCount: 15420,
        imagesUrl: 'https://images.unsplash.com/photo-1539650116574-75c0c6d73e0e?w=500',
      ...
      Place(
        placeId: '2',
        name: 'Royal Palace',
        description: 'Beautiful royal palace complex in Phnom Penh featuring stunning Khmer architecture and important cultural artifacts.',
        categoryId: 1,
        googleMapsLink: 'https://maps.google.com/?q=Royal+Palace,+Phnom+Penh,+Cambodia',
        ratings: 4.5,
        reviewsCount: 8750,
        imagesUrl: 'https://images.unsplash.com/photo-1544530612-7eadc7006f6d?w=500',
      ...
      Place(
        placeId: '3',
        name: 'Bayon Temple',
        description: 'Famous temple known for its massive stone faces and intricate bas-relief carvings.',
        categoryId: 1,
        googleMapsLink: 'https://maps.google.com/?q=Bayon+Temple,+Angkor+Thom,+Cambodia',
        ratings: 4.7,
        reviewsCount: 12300,
        imagesUrl: 'https://images.unsplash.com/photo-1544530612-7eadc7006f6d?w=500',
      ...
      Place(
        placeId: '4',
        name: 'Koh Rong Beach',
        description: 'Pristine tropical beach with crystal clear waters and white sand, perfect for relaxation and water activities.',
        categoryId: 5,
        googleMapsLink: 'https://maps.google.com/?q=Koh+Rong+Beach,+Cambodia',
        ratings: 4.6,
        reviewsCount: 5240,
        imagesUrl: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=500',
        ...
        return Transform.scale(
          ...
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: widget.isSelected ? DertamColors.primaryDark : Colors.transparent,
                borderRadius: BorderRadius.circular(20),
                border: Border.all(
                  color: widget.isSelected ? DertamColors.primaryDark : Colors.grey[300]!,
                ),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Entry Fee
                  if (place.entryFree != null && place.entryFree!) ...[
                    Row(
                      children: [
                        Icon(Icons.money_off, color: Colors.green[600], size: 20),
                        const SizedBox(width: 8),
                        Text(
                          'Free Entry',
                          style: TextStyle(
