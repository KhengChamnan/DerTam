...
class _TripDetailScreenState extends State<TripDetailScreen> {
  ...
  String _formatDateRange() {
    ...
    return '${widget.startDate.day} ${months[widget.startDate.month - 1]} - ${widget.endDate.day} ${months[widget.endDate.month - 1]} ${widget.endDate.year}';
  }
          ...
          SliverList(
            delegate: SliverChildBuilderDelegate((context, index) {
              ...
              return TripDayCard(
                ...
                date: day,
                places: placesForDay,
                onDeletePlace: _deletePlace, // Add this callback
              );
            }, childCount: tripDays.length),
          ),
      ...
      floatingActionButton: Column(
        ...
        children: [
          ...
          FloatingActionButton(
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => SelectPlaceScreen(
                    ...
                    startDate: widget.startDate,
                    endDate: widget.endDate,
                    existingPlaces: widget.addedPlaces, // Pass existing places
                  ),
                ),
              ).then((result) {
            ...
            backgroundColor: Colors.white,
            child: Icon(Icons.add, color: DertamColors.primaryDark, size: 30),
          ),
          SizedBox(height: 10),
