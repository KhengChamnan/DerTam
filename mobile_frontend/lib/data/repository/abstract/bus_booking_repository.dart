...
import 'package:mobile_frontend/models/bus/bus_booking_request.dart' hide BusBookingData;
...
abstract class BusBookingRepository {
  ...
  Future<BusBookingApiResponse> getAllBusBookings();
  Future<BusBookingDataResponse> getBookingDetails(String bookingId);
}
