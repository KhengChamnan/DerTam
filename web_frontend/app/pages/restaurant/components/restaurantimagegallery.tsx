...
export default function RestaurantImageGallery({ images, restaurantName, onImageClick }: RestaurantImageGalleryProps) {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
      <div className="hidden md:block">
        {validImages.length === 1 && (
          <div className="relative h-[400px] overflow-hidden cursor-pointer group" onClick={() => onImageClick?.(0)}>
            <ImageWithFallback
              src={validImages[0]}
              alt={restaurantName}
              ...
              <div className="relative overflow-hidden cursor-pointer group" onClick={() => onImageClick?.(2)}>
                ...
                {validImages.length > 3 && (
                  <div className="absolute inset-0 bg-black/60 flex items-center justify-center">
                    <span className="text-white text-4xl font-semibold">+{validImages.length - 3}</span>
                  </div>
                )}
              </div>
            )}
      ...
      <div className="md:hidden">
        {validImages.length === 1 && (
          <div className="relative h-80 overflow-hidden cursor-pointer group" onClick={() => onImageClick?.(0)}>
            <ImageWithFallback
              src={validImages[0]}
              alt={restaurantName}
              index={images.indexOf(validImages[0])}
        ...
        {validImages.length >= 2 && (
          <div className="grid grid-rows-2 gap-0.5 h-80">
            {validImages[0] && (
